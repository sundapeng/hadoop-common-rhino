...
public class HttpFSTokenAuthAuthenticator extends TokenAuthAuthenticator {
  ...
  public static enum DelegationTokenOperation {
    ...
    private boolean requiresTokenAuthCredentials;

    private DelegationTokenOperation(String httpMethod,
                                     boolean requiresTokenAuthCredentials) {
      this.httpMethod = httpMethod;
      this.requiresTokenAuthCredentials = requiresTokenAuthCredentials;
    }
    ...
    public boolean requiresTokenAuthCredentials() {
      return requiresTokenAuthCredentials;
    }
