...
public class FakeBlockDecryptionStream extends BlockDecryptionStream{

  public FakeBlockDecryptionStream(InputStream in, BlockDecryptorWithDecompressor 
      decryptorWithDecompressor, int blockSize) throws IOException{
    super(in, decryptorWithDecompressor, blockSize);
  }

  public FakeBlockDecryptionStream(InputStream seekableIn, 
