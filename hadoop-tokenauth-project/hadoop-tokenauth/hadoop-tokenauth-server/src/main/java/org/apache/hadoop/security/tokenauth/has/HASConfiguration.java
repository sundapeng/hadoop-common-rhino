...
public class HASConfiguration extends Configuration {
  ...
  public static final String HADOOP_SECURITY_TOKENAUTH_IDENTITY_SERVER_ISSUEDTOKENS_PERSISTENT_ON_EXIT = 
      HADOOP_SECURITY_TOKENAUTH_IDENTITY_SERVER_CONFIG_PREFIX + ".issuedtokens.persistent.on.exit";
