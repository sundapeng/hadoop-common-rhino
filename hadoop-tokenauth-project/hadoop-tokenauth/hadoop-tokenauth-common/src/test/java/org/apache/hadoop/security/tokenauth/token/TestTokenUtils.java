...
public class TestTokenUtils extends TokenTestCase {
  private final String identityTokenName = IdentityToken.class.getName();
  ...
  public void testGetGroups() throws Exception {
    Token identityToken = createToken(null, identityTokenName);
    String[] groups = TokenUtils.getGroups(identityToken);
    for (String g : groups) {
  ...
  public void testGetAttribute() throws Exception {
    Token identityToken = createToken(null, identityTokenName);
    Attribute attr = TokenUtils.getAttribute(identityToken, ATTRIBUTE_TYPE.GROUP.getName());
    System.out.println(attr.getName());
    attr = TokenUtils.getAttribute(identityToken, ATTRIBUTE_TYPE.AGE.getName());
    System.out.println(attr.getName());
  ...
  public void testGetRefreshTime() throws Exception {
    Token identityToken = createToken(null, identityTokenName);
    long refreshTime = TokenUtils.getRefreshTime(identityToken);
  ...
  public void testEncodeToken() throws Exception {
    ...
    byte[] bytes = "hello tokenauth".getBytes();
    String encodeString = TokenUtils.encodeToken(bytes);
    byte[] decodeBytes = TokenUtils.decodeToken(encodeString);
