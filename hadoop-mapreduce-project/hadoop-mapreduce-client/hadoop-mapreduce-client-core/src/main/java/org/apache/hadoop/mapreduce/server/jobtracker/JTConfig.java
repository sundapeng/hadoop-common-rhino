...
public interface JTConfig extends MRConfig {
  ...
  public static final String JT_TOKENAUTH_USER_NAME = "mapreduce.jobtracker.tokenauth.principal";
  public static final String JT_AUTHENTICATION_FILE = 
     "mapreduce.jobtracker.authentication.file";
